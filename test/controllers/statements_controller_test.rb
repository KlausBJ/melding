...
class StatementsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create statement" do
    assert_difference("Statement.count") do
      post statements_url, params: { statement: { content: @statement.content, convention: @statement.convention } }
    end
  ...
  test "should update statement" do
    patch statement_url(@statement), params: { statement: { content: @statement.content, convention: @statement.convention } }
